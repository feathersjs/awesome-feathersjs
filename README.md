...
- [feathers-cassandra](https://github.com/dekelev/feathers-cassandra) - Feathers service adapter for Cassandra based on Express-Cassandra ORM and CassanKnex query builder
