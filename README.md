...
- [feathers-aws-sns](https://github.com/feathersjs-ecosystem/feathers-mailer) - Feathers AWS SNS service to use with Amazon Simple Notification Service (service)
